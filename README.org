...
* Use cases & guides
  NSO in Docker is not just two Docker container images but rather an eco system. Using NSO in Docker is about a way of working and approaching problems. Here's a list of some use cases, examples and guides for how to use NSO in Docker:

  - run netsim as a container
    - see https://gitlab.com/nso-developer/docker-example-ned-ietf/
